...
/**
 * retrieve_environment_variable - Retrieves value of enviro variable.
 * @info: Structure containing potential arguments. Used to maintain
...
/**
 * initialize_or_modify_environment - Init enviro var modifies existing
 * @info: Structure containing potential arguments. Used to maintain
 *        constant function prototype.
 * Return: Always 0
 */
int initialize_or_modify_environment(info_t *info)
{
	if (info->argc != 3)
	{
